...
* 
  Please raise an issue for discussion and reproducibility checks at `issues <https://github.com/Nelson-Gon/cellseg/issues>`_
...
Please note that the 'cellseg' project is released with a
`Contributor Code of Conduct <https://github/com/Nelson-Gon/cellseg/.github/CODE_OF_CONDUCT.md>`_.
